...
cargo fmt --manifest-path plugins/com.dvgamerr.widgets.sdPlugin/Cargo.toml -- --check
...
cargo clippy --manifest-path plugins/com.dvgamerr.widgets.sdPlugin/Cargo.toml --all-targets
...
cargo test --manifest-path plugins/com.dvgamerr.widgets.sdPlugin/Cargo.toml
